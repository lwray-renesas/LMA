...
__far const eel_u08 eel_descriptor[EEL_VAR_NO+2] =
{
  ...
  (eel_u08)(sizeof(LMA_PhaseCalibration)),  	/* id=1             */  \
  (eel_u08)(sizeof(LMA_NeutralCalibration)),  	/* id=2             */  \
  (eel_u08)(sizeof(LMA_GlobalCalibration)),  	/* id=3             */  \
  (eel_u08)(sizeof(LMA_SystemEnergy)),  		/* id=4             */  \
