...
void LMA_AccPhaseRun(LMA_Phase *const p_phase)
{
  ...
  /* Irms*/
  MULR0 = *((uint16_t *)&(p_phase->accs.temp.i_acc));
  MULR1 = *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 1);
  MULR2 = *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 2);
  MULR3 = *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 3);
  ...
  NOP();
  NOP();
  *((uint16_t *)&(p_phase->accs.temp.i_acc)) = MULR0;
  NOP();
  *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 1) = MULR1;
  *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 2) = MULR2;
  *(((uint16_t *)&(p_phase->accs.temp.i_acc)) + 3) = MULR3;

  /* P*/
  MULR0 = *((uint16_t *)&(p_phase->accs.temp.p_acc));
  MULR1 = *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 1);
  MULR2 = *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 2);
  MULR3 = *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 3);

  MULBL = *((uint16_t *)&(p_phase->inputs.v_sample));
  MULBH = *(((uint16_t *)&(p_phase->inputs.v_sample)) + 1);
  NOP();
  NOP();
  *((uint16_t *)&(p_phase->accs.temp.p_acc)) = MULR0;
  NOP();
  *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 1) = MULR1;
  *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 2) = MULR2;
  *(((uint16_t *)&(p_phase->accs.temp.p_acc)) + 3) = MULR3;

  /* Q*/
  MULR0 = *((uint16_t *)&(p_phase->accs.temp.q_acc));
  MULR1 = *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 1);
  MULR2 = *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 2);
  MULR3 = *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 3);

  MULBL = *((uint16_t *)&(p_phase->inputs.v90_sample));
  MULBH = *(((uint16_t *)&(p_phase->inputs.v90_sample)) + 1);
  NOP();
  NOP();
  *((uint16_t *)&(p_phase->accs.temp.q_acc)) = MULR0;
  NOP();
  *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 1) = MULR1;
  *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 2) = MULR2;
  *(((uint16_t *)&(p_phase->accs.temp.q_acc)) + 3) = MULR3;

  /* Vrms*/
  MULR0 = *((uint16_t *)&(p_phase->accs.temp.v_acc));
  MULR1 = *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 1);
  MULR2 = *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 2);
  MULR3 = *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 3);
  ...
  NOP();
  NOP();
  *((uint16_t *)&(p_phase->accs.temp.v_acc)) = MULR0;
  NOP();
  *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 1) = MULR1;
  *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 2) = MULR2;
  *(((uint16_t *)&(p_phase->accs.temp.v_acc)) + 3) = MULR3;

  if (NULL != p_phase->p_neutral)
  {
    /* Irms - NEUTRAL*/
    MULR0 = *((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp));
    MULR1 = *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 1);
    MULR2 = *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 2);
    MULR3 = *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 3);
    ...
    NOP();
    NOP();
    *((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) = MULR0;
    NOP();
    *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 1) = MULR1;
    *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 2) = MULR2;
    *(((uint16_t *)&(p_phase->p_neutral->accs.i_acc_temp)) + 3) = MULR3;
  }
